...
public class DrinkUpdateAdapter extends BaseAdapter {

    private Context context;
    private  int layout;
    private ArrayList<DrinkFood> foodsList2;

    public DrinkUpdateAdapter(Context context, int layout, ArrayList<DrinkFood> foodsList2) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        DrinkFood food = foodsList2.get(position);
