...
import e.mrarifin.cobaeresep.Menu;
...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(new Food(name, price, cara, image, id));
        }
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            ...
                            showDialogTampil(FoodList.this, arrID.get(position));
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        Cursor cursor = MainActivity.sqLiteHelper.getData("SELECT * FROM FOOD WHERE id='" +id+ "'");
    ...
    private void selectImage() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(FoodList.this);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CAMERA) {
                ...
                try {
                    ...
                    bitmap = MediaStore.Images.Media.getBitmap(FoodList.this.getContentResolver(), data.getData());
                    setToImageView(getResizedBitmap(bitmap, max_resolution_image));
                } catch (IOException e) {
                    e.printStackTrace();
                }
